...
public interface AvailabilityFeignClient {
	...
	@PutMapping("/availability/block/{availabilityId}")//done//works
	public ResponseEntity<AvailabilityDto> blockTimeSlot(@PathVariable String availabilityId);
	
	@DeleteMapping("/availability/delete/{availabilityId}")//done//works
	public ResponseEntity<AvailabilityDto> deleteAvailability(@PathVariable String availabilityId);
