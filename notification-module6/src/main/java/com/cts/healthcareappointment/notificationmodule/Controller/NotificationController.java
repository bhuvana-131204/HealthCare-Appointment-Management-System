...
public class NotificationController {
    ...
    public ResponseEntity<Response<?>> notifyAfterBooking(@RequestBody @Valid Notification notification, BindingResult result) {
        if (result.hasErrors()) {
     ...
     */
    @PostMapping("/create")
    public ResponseEntity<Response<Notification>> createNotification(@RequestBody @Valid Notification notification, BindingResult result) {
        if (result.hasErrors()) {
            log.error("Validation errors: {}", result.getFieldErrors());
